...
% step 3) REQUIRED: press F12 to generate index file and create index chapeter
% step 4) REQUIRED: press F1  to build and view output PDF
...
% Use \cite[page 23]{kennedy1998cationic}  for example when citing bibliography references contained in the .bib 
% bibtex file
