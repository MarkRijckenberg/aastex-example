...
% texstudio 2.2 (compiled from svn source) works a lot better and is more stable than texmaker in Ubuntu
% Build procedure in texstudio 2.2 (svn) or texmaker 4.0.1:
...
% unnumbered ones.
% Use \citep{kennedy1998cationic}  for example when citing bibliography references contained in the .bib bibtex file
