...
% Build procedure in texmaker 4.0.1 or texstudio 2.2 (svn):
% 1) press Tools:Clean within texmaker to delete old output files
% 2) press F11,F1,F11 and F1 within texmaker menu 
% to correctly compile this .tex file into a valid .PDF output file.
% use the Terminal command  "texdoc <packagename>" to get documentation about a specific tex package
% always save graphics files in .PDF format, not in .JPG or .PNG format
...
% unnumbered ones.
% Use \citep{kennedy1998cationic}  for example when citing bibliography references in the .bib bibtex file
...
\citep{kennedy1998cationic}.  This paper details the survey observations and
